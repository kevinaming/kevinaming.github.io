...
const I18N_UI = {
  es: {
    ...
    'grados.placeholder': 'Selecciona un salón, maestro/a de salón hogar o grupo para ver su horario.',
    'grados.todos-grupos': 'Todos los niveles',
    'grados.todos-maestros': 'Todos los maestros/as de salón hogar',
    'grados.todos-clases': 'Todos los maestros/as que dan la clase',
    'grados.pendiente-confirmar': 'Por confirmar',
  ...
  en: {
    ...
    'grados.placeholder': 'Pick a classroom, homeroom teacher, or group to see its schedule.',
    'grados.todos-grupos': 'All levels',
    'grados.todos-maestros': 'All homeroom teachers',
    'grados.todos-clases': 'All class teachers',
    'grados.pendiente-confirmar': 'To be confirmed',
...
const I18N_GROUP_NAMES = [
  ...
  ['(1ro y 2do)', '(1st & 2nd)'],
  ['(Kínder)', '(Kindergarten)'],
  ['No Categorizado', 'Uncategorized'],
  ['EE Ruta 2 y 3', 'SPED Route 2 & 3'],
  ['EE Ruta 1', 'SPED Route 1'],
  ['PK EE', 'PK SPED'],
  ['Autismo', 'Autism'],
  ['Pre-Kínder', 'Pre-K'],
  ['1er Grado', '1st Grade'],
...
const I18N_SUBJECTS = [
  ...
  ['Integración Curricular', 'Curriculum Integration'],
  ['Artes Visuales', 'Visual Arts'],
  ['Adq. Lengua', 'Language Acquisition'],
...
const I18N_PHRASES = [
  ...
  ['PREP — R1-K, R1-1R, R23-123 y R23-345', 'PREP — R1-K, R1-1R, R23-123, and R23-345'],
  ['PREP — R1-12, R1-34, R1-56 y R1-78', 'PREP — R1-12, R1-34, R1-56, and R1-78'],
  ['PREP — 6to', 'PREP — 6th'],
  ['PREP — 7mo', 'PREP — 7th'],
  ['PREP — 5to', 'PREP — 5th'],
  ['PREP — 8vo', 'PREP — 8th'],
